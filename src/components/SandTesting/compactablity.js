...
const RunnerChart = () => {
  ...
  console.log(limits.upperlimit,limits.lower)
      ...
      <div className="print-page">
        <div className="print-header">
          ...
          <div className="print-limits">
            <p> Characteristics: Compactibility % | Specification:{(limits.lower)} TO {(limits.upper)} %</p>
  ...
  const chartContent = (
    ...
    >
      ...
      <XAxis 
        ...
        fontSize={10}
      />
      <YAxis domain={[limits.lowerlimit, limits.upperlimit]} />
      <Tooltip content={<CustomTooltip />} />
      <Legend />
      <ReferenceArea y1={limits.lowerlimit} y2={limits.yellowLower} fill="red" fillOpacity={0.8} />
      ...
      <ReferenceArea y1={limits.yellowUpper} y2={limits.upperlimit} fill="red" fillOpacity={1.0} />
      <Line
    ...
    <Card style={{ maxWidth: '1200px', margin: 'auto', marginTop: '20px', padding: '20px' }}>
      ...
      <CardContent>
        ...
        <Typography variant="subtitle1" gutterBottom>
          Characteristics: Compactibility % | Specification:{(limits.lower)} TO {(limits.upper)} %
        </Typography>
