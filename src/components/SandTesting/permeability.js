...
const RunnerChart = () => {
  ...
  const [upperLimit, setUpperLimit] = useState(160);
  const [lowerLimit, setLowerLimit] = useState(110);
  const [greenUpperLimit, setGreenUpperLimit] = useState(145);
  const [greenLowerLimit, setGreenLowerLimit] = useState(125);
  const [yellowUpperLimit, setYellowUpperLimit] = useState(155);
  const [yellowLowerLimit, setYellowLowerLimit] = useState(115);
    ...
    <div className="print-only">
      <div className="print-header">
        ...
        <div className="print-limits">
          <p>Characteristics: Permeability No's | Specification: {limits.lower} TO {limits.upper} gm/cm²</p>
