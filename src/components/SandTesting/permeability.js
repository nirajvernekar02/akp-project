...
const RunnerChart = () => {
  ...
  const getColor = (value) => {
    // Red zone: below 115 or above 155
    ...
    return '#000000'; // Black (default)/ Black (default)
  };
  ...
  const chartContent = (
    ...
    >
      ...
      <ReferenceArea y1={limits.yellowUpper} y2={limits.upperlimit} fill="red" fillOpacity={0.8} />
      <Line
    ...
    <Card style={{ maxWidth: '1200px', margin: 'auto', marginTop: '20px', padding: '20px' }}>
      ...
      <CardContent>
        ...
        <Typography variant="subtitle1" gutterBottom>
          Characteristics: Permeability | Specification: {(limits.lower +5 )} TO {(limits.upper-5)} 
        </Typography>
